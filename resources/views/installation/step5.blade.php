...
@section('content')
    ...
    <!-- Progress -->
    <div class="pb-2">
        <div class="progress cursor-pointer" role="progressbar" aria-label="Fasta Deliveries Installation"
                            ...
                            <div class="col-md-12">
                                <div class="from-group">
                                    ...
                                    <input type="text" id="first-name" class="form-control" name="business_name"
                                           required placeholder="Ex: Fasta Deliveries">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="from-group">
