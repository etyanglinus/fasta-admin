...
class Zone extends Model
{
    ...
    {
        return $this->belongsToMany(Module::class)->withPivot(['micro_zone_id','per_km_shipping_charge','minimum_shipping_charge','maximum_shipping_charge','maximum_cod_order_amount','delivery_charge_type','fixed_shipping_charge'])->using('App\Models\ModuleZone');
    }
